...
<head>
    ...
    <?PHP
        ...
        //$DI="08717648200274";
        $DI="00814008024049";//Has a single sterilization method
        //$DI="D0470046351";
        ...
        // //echo "Storage and Handling ". sizeof($storageConditions);
        // $storageHandling=$storageConditions[0];
        ...
        //$sterilizationMethodTypes=$sterilization["methodTypes"];

        
        //echo "hello?".$steriliationMethodTypes["sterilizationMethod"];

        //$sterilizationMethods=$sterilizationMethodTypes["sterilizationMethod"];
        //$sterilizationMethod="";
    
        // if (isset($steriliationMethods)){
        //     for ($ii=0; $ii<= sizeof($sterilizationMethods); $ii++){
        //         $sterilizationMethod= $steriliationMethod . "," . $sterilizationMethod[$ii];
        //         echo sterilizationMethod[$ii];
        //     }//end for

        // }//end sterilization if
        // else{
        //      echo "Sterilization Method not set";
        //      $sterilizationMethod="Not specified";
        // }//end sterilization else
        // echo $sterilizationMethod;
...
<body>
    ...
    <FORM NAME ="form1" METHOD ="POST" ACTION = "GUDID2.php">
